  ...
  >
    ...
    >
      ...
      <ul class="text-sm mt-10px text-xs">
        <li>
          ・<span class="info-key-text mr-5px">/ t</span> Search your tabs
        </li>
        <li class="mt-10px">
          ・<span class="info-key-text mr-5px">/ b</span> Search your bookmarks
        </li>
        <li class="mt-10px">
          ・<span class="info-key-text mr-5px">/ h</span> Search your histories
        </li>
      </ul>
    </div>
    <div
    ...
    >
      ...
      <ul class="text-sm mt-10px text-xs">
        <li>
          ・<span class="info-key-text mr-5px">Alt(Option) + k</span>Open or
          Close Search form
        </li>
        <li class="mt-10px">
          ・<span class="info-key-text">↑</span>
          <span class="info-key-text">↓</span>or<span class="info-key-text"
            >Ctrl + n</span
          >
