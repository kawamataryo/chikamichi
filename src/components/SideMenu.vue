<template>
  <ul class="w-full dark:text-gray-200 text-gray-900 mt-20px flex flex-col items-center">
    <li class="p-10px rounded-full dark:hover:bg-gray-700 hover:bg-gray-200 cursor-pointer" :class="currentTabClasses(PAGES.SEARCH)" @click="changePage(PAGES.SEARCH)">
