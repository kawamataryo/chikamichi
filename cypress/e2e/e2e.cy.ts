...
describe("App", () => {
  ...
  describe("Search", () => {
    ...
    describe("favorite", () => {
      it("check and uncheck favorite items", () => {
        cy.get("[data-cy=search-input]").type("history-item");
        cy.get("[data-cy=search-result-0]").should(
          "have.class",
          "selected-item"
      ...
      it("change order of favorite items", () => {
        ...
        // change order
        cy.get("[data-cy=search-input]").type("{shift}{ctrl}n");
        cy.get("[data-cy=search-result-1]").should(
          "have.class",
          "selected-item"
        );
        ...
        // reverse order
        cy.get("[data-cy=search-input]").type("{shift}{ctrl}p");
        cy.get("[data-cy=search-result-0]").should(
          "have.class",
          "selected-item"
        );
